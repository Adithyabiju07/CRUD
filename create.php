...
if (isset($_POST['save'])) {
    ...
    if (!$hasError) {
        ...
        ");
        echo json_encode(['status' =>'success', 'message' =>'Student record created']);

        header("Location: create.php?success=1");
        exit;
    }
    else{
        echo json_encode(['status' =>'success', 'message' =>'All fields are required']);
        exit;
    }
}
?>
...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="d-flex justify-content-between">
            ...
            <a href="lindex.php" class="btn btn-warning">View Students</a>
        </div>
    </div>
